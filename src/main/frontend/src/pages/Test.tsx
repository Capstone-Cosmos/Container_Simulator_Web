...
export default function Test(){
  ...
  <div className="relative h-screen bg-[#f1f3f5] overflow-hidden">
    ...
    <div className="absolute -translate-x-1/2 left-[calc(50%+190px)] top-[120px] w-[360px] h-[576px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[4px]"></div>
    <Link to={"/member/join"}className="absolute -translate-x-1/2 left-[calc(50%+-190px)] top-[529px] text-[34px] font-['Noto_Sans_KR'] font-bold text-[#74b5dd] text-center whitespace-nowrap">사용자<br/>회원가입</Link>
    <div className="absolute -translate-x-1/2 left-[calc(50%+190px)] top-[529px] text-[34px] font-['Noto_Sans_KR'] font-bold text-[#74b5dd] text-center whitespace-nowrap">담당자<br/>회원가입</div>
