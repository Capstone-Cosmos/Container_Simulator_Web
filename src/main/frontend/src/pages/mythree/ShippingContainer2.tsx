      ...
      <group visible={visible} >
        <RigidBody type="fixed" colliders="trimesh" >
          <mesh  castShadow receiveShadow rotation={[0,0,0]} position={[1.23, 1.3 + globalVar.get_dy, existingToContainer -0.4*2]}>
            <boxGeometry args={[0.02, 2.55, 6.5*2]} />
          ...
          <mesh  castShadow receiveShadow rotation={[0,0,0]} position={[0, 1.3 + globalVar.get_dy + 1.25, existingToContainer -0.9]}>
            <boxGeometry args={[2.55, 0.02, 6.5*2]} />
            <meshStandardMaterial transparent opacity={opacity} wireframe={wireframe} color={containerColor} />
          </mesh>
        </RigidBody>


        <group {...props} position={[0,-0.7,existingToContainer]}dispose={null} scale={[0.02*ratio,0.02*ratio,0.04*ratio]}>
