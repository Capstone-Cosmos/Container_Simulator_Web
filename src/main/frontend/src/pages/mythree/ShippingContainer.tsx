...
export default function ShippingContainer(props:any) {
  ...
  return (
      <group>
        <group {...props} position={[0,-0.5,0]}dispose={null} scale={0.02}>
        ...
        <group {...props} position={[20,-0.5,-5.5]}dispose={null} scale={[0.02,0.02*1.13,0.04]}>
          <RigidBody type={rigidbody? "fixed" : "dynamic"} colliders="trimesh" >
            <group>
              <mesh
                  castShadow
        ...
        <group {...props} position={[10,-0.5,-5.5]}dispose={null} scale={[0.02,0.02,0.04]}>
          <RigidBody type={rigidbody? "fixed" : "dynamic"} colliders="trimesh" >
            <group>
              <mesh
                  castShadow
