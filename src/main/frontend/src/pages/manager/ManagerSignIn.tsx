...
export default function ManagerSingIn() {
    ...
    const onSubmit =
        (e:any) => {
            ...
            if (email == '' || managerName == '' || managerDepart == '' || managerPosition == ''){ alert('모든 정보를 입력해주세요.'); return; }
            else {
                axios
                    .post('/managers', {
                        id,
    ...
    return (
        <div className="relative h-[1680px] bg-[#f1f3f5] overflow-hidden">
            ...
            <div className="absolute -translate-x-1/2 left-1/2 top-[296px] w-[550px] h-[133px]">
                <input type="text" id="id" name="id" value={id} onChange={onChangeid} placeholder="아이디"className="absolute left-0 right-0 top-[25.56%] bottom-[25.56%] bg-[#f1f3f5] rounded-[4px]"></input>
