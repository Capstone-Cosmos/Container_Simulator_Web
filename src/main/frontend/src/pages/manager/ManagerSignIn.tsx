...
export default function ManagerSingIn(){
  ...
  const onSubmit = useCallback(
    ...
    [managerId, managerPassword, managerPasswordCheck, managerEmail,  managerName, managerDepart, managerPosition],
  );
    ...
    <div className="relative h-[1680px] bg-[#f1f3f5] overflow-hidden">
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[296px] w-[550px] h-[133px]">
        <input type="text" id="managerId" name="managerId" value={managerId} onChange={onChangeManagerId} className="absolute left-0 right-0 top-[25.56%] bottom-[25.56%] bg-[#f1f3f5] rounded-[4px]"></input>
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[469px] w-[550px] h-[133px]">
        <input type="password" id="managerPassword" name="managerPassword" value={managerPassword} onChange={onChangemanagerPassword} className="absolute left-0 right-0 top-[25.56%] bottom-[25.56%] bg-[#f1f3f5] rounded-[4px]"></input>
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[642px] w-[550px] h-[133px]">
        <input type="password" id="managerPassword-check" name="managerPassword-check" value={managerPasswordCheck} onChange={onChangemanagerPasswordCheck} className="absolute left-0 right-0 top-[25.56%] bottom-[25.56%] bg-[#f1f3f5] rounded-[4px]"></input>
        <div className="absolute left-0 right-[50.91%] top-[80.45%] bottom-0 text-[18px] font-['Noto_Sans_KR'] font-medium text-[#adb5bd] whitespace-nowrap">{mismatchError && (<div>비밀번호가 일치하지 않습니다.</div>)}</div>
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[815px] w-[550px] h-[133px] flex">
        <input type="email" id="managerEmail" name="managerEmail" value={managerEmail} onChange={onChangeManagerEmail} className="absolute left-0 right-0 top-[25.56%] bottom-[25.56%] bg-[#f1f3f5] rounded-[4px]"></input>
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-[954px] w-[549px] h-[133px] flex">
        <div className="absolute left-0 right-[93.81%] top-0 bottom-[86.24%] text-[18px] font-['Noto_Sans_KR'] font-medium text-[#868e96] whitespace-nowrap">관리자명</div>
        <div className="absolute left-0 top-[39px] w-[549px] h-[65px] flex">
          <input type="text" id="managerName" name="managerName" value={managerName} onChange={onChangeManagerName} className="absolute left-0 right-0 top-0 bottom-0 bg-[#f1f3f5] rounded-[4px]"></input>
        </div>
      </div>

      {/*업체명*/}
      <div className="absolute -translate-x-1/2 left-1/2 top-[1093px] w-[549px] h-[104px] flex">
        <div className="absolute left-0 right-[90.89%] top-0 bottom-[75%] text-[18px] font-['Noto_Sans_KR'] font-medium text-[#868e96] whitespace-nowrap">부서</div>
        <div className="absolute left-0 top-[39px] w-[549px] h-[65px] flex">
          <input type="text" id="managerDepart" name="managerDepart" value={managerDepart} onChange={onChangeManagerDepart} className="absolute left-0 right-0 top-0 bottom-0 bg-[#f1f3f5] rounded-[4px]"></input>
        </div>
      </div>

      {/*대표명*/}
      <div className="absolute -translate-x-1/2 left-1/2 top-[1232px] w-[549px] h-[104px] flex">
        <div className="absolute left-0 right-[90.89%] top-0 bottom-[75%] text-[18px] font-['Noto_Sans_KR'] font-medium text-[#868e96] whitespace-nowrap">직책</div>
        <div className="absolute left-0 top-[39px] w-[549px] h-[65px] flex">
          <input type="text" id="managerPosition" name="managerPosition" value={managerPosition} onChange={onChangeManagerPosition}className="absolute left-0 right-0 top-0 bottom-0 bg-[#f1f3f5] rounded-[4px]"></input>
        </div>
      </div>
