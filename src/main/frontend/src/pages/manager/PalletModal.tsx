...
export default function PalletModal({urlcontainerId, productId}:any) {
    ...
    return (
        <div>
            <button className="px-4 p-2 text-base font-bold text-center bg-white border-2 rounded-lg text-appr hover:bg-appr hover:text-white border-appr" onClick={openModal}> 등록 </button>
            ...
            <Modal isOpen={isOpen} onRequestClose={closeModal} style={customStyles}>
                <div className="relative w-[700px] h-[465px]">
                    ...
                    <div className="absolute left-[645px] top-[133px] w-[54px] h-[30px] flex">
                        ...
                        <div className="absolute left-[14.06%] right-[12.41%] top-[17.86%] bottom-[21.43%] text-[12px] font-['Noto_Sans_KR'] font-bold text-[#74b5dd] text-center">추가</div>
                    </div>
