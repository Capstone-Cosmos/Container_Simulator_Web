            ...
            <Modal isOpen={isOpen} onRequestClose={closeModal} style={customStyles}>
                <div className="relative w-[700px] h-[465px]">
                    ...
                    <div className="absolute left-[645px] top-[133px] w-[54px] h-[30px] flex">
                        <button className="absolute left-0 top-0 w-[54px] h-[30px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[6px] hover:bg-cb hover:text-white text-cb text-[14px] font-bold " onClick={()=> addPallet('PALLET_TYPE_11A')}>추가</button>
                    </div>
                    ...
                    <div className="absolute left-[645px] top-[405px] w-[54px] h-[30px] flex">
                        <button className="absolute left-0 top-0 w-[54px] h-[30px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[6px] hover:bg-cb hover:text-white text-[14px] font-bold  text-cb" onClick={()=> addPallet('PALLET_TYPE_15A')}>추가</button>
                    </div>
                    ...
                    <div className="absolute left-[645px] top-[337px] w-[54px] h-[30px] flex">
                        <button className="absolute left-0 top-0 w-[54px] h-[30px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[6px] hover:bg-cb hover:text-white text-cb text-[14px] font-bold " onClick={()=> addPallet('PALLET_TYPE_13B')}>추가</button>
                    </div>
                    ...
                    <div className="absolute left-[645px] top-[269px] w-[54px] h-[30px] flex">
                        <button className="absolute left-0 top-0 w-[54px] h-[30px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[6px] hover:bg-cb hover:text-white text-cb text-[14px] font-bold " onClick={()=> addPallet('PALLET_TYPE_11B')}>추가</button>
                    </div>
                    ...
                    <div className="absolute left-[645px] top-[201px] w-[54px] h-[30px] flex">
                        <button className="absolute left-0 top-0 w-[54px] h-[30px] bg-[#f8f9fa] border-[1px] border-solid border-[#74b5dd] rounded-[6px] hover:bg-cb hover:text-white text-cb text-[14px] font-bold" onClick={()=> addPallet('PALLET_TYPE_12A')}>추가</button>
                    </div>
